...
# CrossGAT Stage-B — eligibility loss

Two-class eligibility model with the auxiliary eligibility margin loss alongside focal cross-entropy.
...
| fusion w=0.3 | 0.6242 | +0.0269 | 3.82e-06 | 0.919 |
| fusion w=0.5 | 0.6304 | +0.0331 | 2.04e-05 | 0.905 |
| fusion w=0.7 | 0.6154 | +0.0180 | 0.0888 | 0.844 |
| fusion w=1 | 0.5133 | -0.0840 | 0.000401 | 0.720 |
...
pipeline = InferencePipeline("2class-eligloss", fold=0)
