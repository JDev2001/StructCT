...
# CrossGAT Stage-B — cross-entropy control

Two-class eligibility model trained with focal cross-entropy only. The matched control for the LambdaRank variant: identical in every other config field.
...
| fusion w=0.3 | 0.6189 | +0.0216 | 7.22e-05 | 0.915 |
| fusion w=0.5 | 0.6288 | +0.0314 | 9.01e-05 | 0.902 |
| fusion w=0.7 | 0.6134 | +0.0161 | 0.219 | 0.852 |
| fusion w=1 | 0.5245 | -0.0728 | 0.000926 | 0.717 |
